  ...
  return (
    <section className="relative px-6 md:px-16 lg:px-28 pt-8 pb-24 bg-white overflow-hidden font-open-sans">
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <h2 className="font-volkhov font-bold text-[32px] md:text-4xl lg:text-5xl text-foreground">
          We Offer Best Services
        </h2>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 relative z-10 max-w-7xl mx-auto">
        {services.map((service, idx) => (
          <div key={idx} className="relative group flex justify-center">
            ...
            <div className={`
              relative z-10 flex flex-col items-center text-center p-8 rounded-[36px] transition-all duration-300 w-full max-w-[280px]
              ${service.isActive
                ? 'bg-white shadow-[0_40px_60px_-15px_rgba(0,0,0,0.15)] bg-opacity-100'
            ...
            `}>
              ...
              <p className="font-poppins text-gray-text text-sm md:text-base font-medium leading-relaxed">
                {service.description}
              </p>
            </div>
          </div>
